...
import { CommonFieldConfig, StorageConfig } from './config';
...
export type NextFieldType<
  ...
  CreateArg extends graphql.Arg<graphql.InputType> | undefined = graphql.Arg<graphql.InputType> | undefined,
  UpdateArg extends graphql.Arg<graphql.InputType> = graphql.Arg<graphql.InputType>,
  UniqueWhereArg extends graphql.Arg<graphql.NullableInputType, false> = graphql.Arg<graphql.NullableInputType, false>,
  OrderByArg extends graphql.Arg<graphql.NullableInputType, false> = graphql.Arg<graphql.NullableInputType, false>,
  FilterArg extends graphql.Arg<graphql.NullableInputType, false> = graphql.Arg<graphql.NullableInputType, false>,
...
export type OrderByFieldInputArg<Val, TArg extends graphql.Arg<graphql.NullableInputType>> = {
  ...
  (value: Exclude<graphql.InferValueFromArg<TArg>, null | undefined>, context: PickerContext) => MaybePromise<Val>
>;
...
type ResolveFunc<Func extends (firstArg: any, ...args: any[]) => any> = Parameters<Func>[0] extends UnwrapMaybePromise<
  ReturnType<Func>
>
  ? { resolve?: Func }
  : { resolve: Func };
...
export type UniqueWhereFieldInputArg<Val, TArg extends graphql.Arg<graphql.InputType>> = {
  ...
  (value: Exclude<graphql.InferValueFromArg<TArg>, undefined | null>, context: PickerContext) => MaybePromise<Val>
>;
...
> = {
  ...
  __pickerTelemetryFieldTypeName?: string;
...
export function fieldType<TDBField extends DBField, ListTypeInfo extends BaseListTypeInfo>(dbField: TDBField) {
  ...
  >(
    graphQLInfo: FieldTypeWithoutDBField<TDBField, CreateArg, UpdateArg, UniqueWhereArg, OrderByArg, FilterArg>
  ): NextFieldType<TDBField, CreateArg, UpdateArg, UniqueWhereArg, OrderByArg, FilterArg, ListTypeInfo> {
