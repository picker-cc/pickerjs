...
export type FieldController<FormState, FilterValue extends JSONValue = never> = {
  ...
  filter?: {
    ...
    Filter(props: { type: string; value: FilterValue; onChange(value: FilterValue): void; autoFocus?: boolean }): null;
  };
};
...
export type CellComponent<
  FieldControllerFn extends (...args: any) => FieldController<any, any> = () => FieldController<any, any>
> = {
  (props: {
