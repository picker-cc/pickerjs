  ...
  meta => {
    ...
    return fieldType({
      ...
      input: {
        ...
        create: {
          arg: graphql.arg({
            type: config.graphql?.create?.isNonNull ? graphql.nonNull(graphql.CalendarDay) : graphql.CalendarDay,
      ...
      output: graphql.field({
        type: config.graphql?.read?.isNonNull ? graphql.nonNull(graphql.CalendarDay) : graphql.CalendarDay,
        resolve({ value }) {
...
export interface CalendarDayFieldMeta {
