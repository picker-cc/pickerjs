...
import { BaseModelTypeInfo, CommonFieldConfig, fieldType, FieldTypeFunc } from '../../../types';
import { userInputError } from '../../../error/graphql-errors';
import { humanize } from '../../../../utils/utils';
import { graphql } from '../../../types/schema';

export type PasswordFieldConfig<ModelTypeInfo extends BaseModelTypeInfo> = CommonFieldConfig<ModelTypeInfo> & {
  /**
   * @default 10
   */
  workFactor?: number;
...
export const password =
  ...
  meta => {
    ...
    return fieldType({
      ...
      __pickerTelemetryFieldTypeName: '@pickerjs/password',
