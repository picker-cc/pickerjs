...
export type CheckboxFieldConfig<ModelTypeInfo extends BaseModelTypeInfo> = CommonFieldConfig<ModelTypeInfo> & {
  ...
  meta => {
    ...
    return fieldType({
      ...
      input: {
        ...
        create: {
          arg: graphql.arg({
            type: config.graphql?.create?.isNonNull ? graphql.nonNull(graphql.Boolean) : graphql.Boolean,
