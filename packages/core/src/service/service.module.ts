...
const services = [ConfigService, AssetService];
 ...
 */
@Module({
  imports: [ConfigModule, CacheModule, EventBusModule],
  // providers: [...services, ...helpers, InitializerService],
  providers: [...services],
  exports: [...services]
})
export class ServiceCoreModule implements OnModuleInit {
  constructor() {} // private administratorService: AdministratorService, // private roleService: RoleService,
