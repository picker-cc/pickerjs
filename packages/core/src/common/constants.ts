...
import type { PermissionMetadata } from './permission-definition';
...
export const DEFAULT_PERMISSIONS: PermissionDefinition[] = [
  ...
  new CrudPermissionDefinition('Catalog', operation => `授权限给 ${operation} Assets, Collections`),
  new CrudPermissionDefinition('Settings', operation => `授权限给 ${operation} System & GlobalSettings`),
