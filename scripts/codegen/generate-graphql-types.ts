...
import { ADMIN_API_PATH, STUDIO_API_PATH } from '../../packages/common/src/shared-constants';
...
const E2E_ADMIN_QUERY_FILES = path.join(__dirname, `../../packages/core/e2e/**/!(${specFileToIgnore.join('|')}).ts`);
